...
import com.lichao.mmall.service.IFileService;
...
public class ProductManagerController {
    ...
    public ServerResponse productSave(HttpSession session, Product product){
        ...
        if (user==null){
            return ServerResponse.createByErrorCodeMessage("用户未登录请登录管理员",ResponseCode.NEED_LOGIN.getCode());
        }
    ...
    @RequestMapping(value = "up_load.do")
    @ResponseBody
